...
public interface PaymentsService {
     ...
     */
    Payments getById(PaymentsId paymentsId);
     ...
     *
     * @param paymentsIds The id's of the Payments to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Payments associated with the given paymentsIds.
     */
    List<Payments> findByMultipleIds(List<PaymentsId> paymentsIds, boolean orderedReturn);
     ...
     */
    Payments update(@Valid Payments payments);
     ...
     */
    Payments delete(PaymentsId paymentsId);

    /**
     * Deletes an existing Payments with the given object.
     *
     * @param payments The instance of the Payments to be deleted; value cannot be null.
     */
