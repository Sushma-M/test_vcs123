...
public interface ArticleTagssxService {
     ...
     */
    ArticleTagssx getById(ArticleTagssxId articletagssxId);
	...
	/**
     * Find and return the list of ArticleTagssxes by given id's.
     *
     ...
     *
     * @param articletagssxIds The id's of the ArticleTagssx to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return ArticleTagssxes associated with the given articletagssxIds.
     */
    List<ArticleTagssx> findByMultipleIds(List<ArticleTagssxId> articletagssxIds, boolean orderedReturn);
     ...
     */
    ArticleTagssx update(@Valid ArticleTagssx articleTagssx);
     ...
     */
    ArticleTagssx delete(ArticleTagssxId articletagssxId);

    /**
     * Deletes an existing ArticleTagssx with the given object.
     *
     * @param articleTagssx The instance of the ArticleTagssx to be deleted; value cannot be null.
     */
    void delete(ArticleTagssx articleTagssx);
