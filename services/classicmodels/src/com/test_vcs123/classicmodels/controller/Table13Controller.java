...
import com.test_vcs123.classicmodels.service.Table13Service;
...
public class Table13Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table13 editTable13(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
