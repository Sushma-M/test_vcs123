...
import com.test_vcs123.classicmodels.service.Mytable2Service;
...
public class Mytable2Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable2 editMytable2(@RequestParam("id") Integer id, @RequestParam("col1") Integer col1, @RequestBody Mytable2 mytable2) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMytable2(@RequestParam("id") Integer id, @RequestParam("col1") Integer col1) {
    ...
    public Page<Mytable2> searchMytable2sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Mytable2s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Mytable2> findMytable2s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Mytable2s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportMytable2sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Mytable2.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> mytable2Service.export(exportOptions, pageable, outputStream));
