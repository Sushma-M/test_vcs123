...
import com.test_vcs123.classicmodels.Payments;
import com.test_vcs123.classicmodels.PaymentsId;
import com.test_vcs123.classicmodels.service.PaymentsService;
...
public class PaymentsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Payments getPayments(@RequestParam("checkNumber") String checkNumber, @RequestParam("customerNumber") Integer customerNumber) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Payments editPayments(@RequestParam("checkNumber") String checkNumber, @RequestParam("customerNumber") Integer customerNumber, @RequestBody Payments payments) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deletePayments(@RequestParam("checkNumber") String checkNumber, @RequestParam("customerNumber") Integer customerNumber) {
    ...
    public Page<Payments> searchPaymentsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Payments list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Payments> findPayments(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Payments list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportPaymentsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Payments.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> paymentsService.export(exportOptions, pageable, outputStream));
